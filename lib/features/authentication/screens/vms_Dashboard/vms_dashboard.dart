            ...
            child: Column(
              children: [
                ...
                TextFormField(decoration: const InputDecoration(
                  labelText: "Subject of application",
                ...
                const SizedBox(height: VSizes.spacesBtwSections,),
                /// Sign up button
                SizedBox(width: double.infinity,child: ElevatedButton(onPressed: (){}, child: const Text("Submit Application")),),
                const SizedBox(height: VSizes.spaceBtwInputFields,),
                SizedBox(width: double.infinity,child: ElevatedButton(onPressed: (){}, child: const Text("Edit Application")),),
                const SizedBox(height: VSizes.spaceBtwInputFields,),
                SizedBox(width: double.infinity,child: ElevatedButton(onPressed: (){}, child: const Text("Delete Application")),),
              ],
            ),
          ),
              const SizedBox(
